...
public class AutoCompleteAdapter1 extends ArrayAdapter<AutocompletePrediction> implements Filterable {

    private ArrayList<AutocompletePrediction> mResultList;
    private PlacesClient placesClient;

    public AutoCompleteAdapter1(Context context, PlacesClient placesClient) {
